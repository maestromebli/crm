            ...
            <div className="space-y-3 px-4 pb-4 pt-2">
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  className="mt-1 w-full rounded-xl border border-violet-200/90 bg-white px-3 py-2 text-sm text-violet-950 shadow-inner placeholder:text-violet-400/80 focus:border-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-200"
                />
              </label>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <motion.button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 px-4 py-2 text-xs font-semibold text-white shadow-md transition hover:from-violet-700 hover:to-fuchsia-700 disabled:cursor-not-allowed disabled:opacity-45"
                >
                  {aiBusy ? (
