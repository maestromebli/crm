...
const CONSTRUCTOR_MODULE_LIST_ROLES = new Set([
  "SUPER_ADMIN",
  "ADMIN",
  "DIRECTOR",
  "DIRECTOR_PRODUCTION",
...
export default async function CrmConstructorWorkspacesPage() {
  ...
  return (
    <main className="space-y-4 p-4 md:p-6">
      <header>
        <h1 className="text-xl font-semibold text-[var(--enver-text)]">Конструкторський модуль</h1>
        <p className="mt-1 text-sm text-slate-600">
          Окремий список воркспейсів конструктора після запуску у виробництво.
          На екрані — до 500 останніх за оновленням; для експорту «CSV (сервер)» — до 2000 записів.
        </p>
      </header>
